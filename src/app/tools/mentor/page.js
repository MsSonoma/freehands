...
export default function MentorVoiceStudioPage() {
  ...
  async function handleSynthesize() {
    ...
    try {
      ...
      // mentor-tts returns raw base64, not a full data URL
      const dataUrl = data.audio.startsWith('data:')
        ? data.audio
      ...
      <div style={{ width: '100%', maxWidth: 720 }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 20 }}>
          <button
            ...
            style={{
              background: status === 'loading' ? '#333' : '#92400e',
              color: '#fff',
              border: 'none',
              borderRadius: 8,
              padding: '10px 24px',
