// Session Takeover Dialog - requires PIN to take over lesson session from another device
'use client'
...
export default function SessionTakeoverDialog({ 
  ...
  const lessonName = existingSession?.lesson_name || existingSession?.lesson_id || 'a lesson'
