...
export class TeachingController {
  ...
  async #fetchConceptFromGPT() {
    ...
    const instruction = [
      ...
      'End on the teaching content itself. Do NOT announce definitions or the next step; the application owns that transition.',
      '',
  ...
  async #fetchDefinitionsFromGPT() {
    ...
    const instruction = [
      ...
      'End on the final definition. Do NOT announce the next teaching section; the application owns that transition.',
  ...
  async #fetchLectureFromGPT() {
    ...
    const instruction = [
      ...
      'Do NOT ask any questions.',
      'Do NOT use numbered lists, bullet points, or any list formatting.',
      'End on the explanation itself. Do NOT announce examples or the next step; the application owns that transition.',
      '',
