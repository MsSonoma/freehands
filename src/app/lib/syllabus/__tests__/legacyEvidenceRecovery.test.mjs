...
test('additive migration constrains verified evidence and contains no backfill or canonical DML', () => {
  ...
  const normalizedBytes = Buffer.from(sql.replace(/\r\n/g, '\n'), 'utf8')
  assert.equal(createHash('sha256').update(normalizedBytes).digest('hex'), '2fc6a9411475483f53fd86572fa8408522a8b41f73417adea79e8f29f13d36d7')
