...
export const riddlesBySubject = {
  general: [
    // Generic riddles that work for any subject
    ...
    { id: 'gen-10', subject: 'general', lines: ['What gets bigger the more you take away?'], pausesMs:[0], answer: 'hole' },
    { id: 'gen-11', subject: 'general', lines: ['What goes up and never comes down?'], pausesMs:[0], answer: 'your age' },
    { id: 'gen-12', subject: 'general', lines: ['What has one eye but cannot see?'], pausesMs:[0], answer: 'needle' },
    { id: 'gen-13', subject: 'general', lines: ['I am lighter than a feather but even the strongest cannot hold me more than a few minutes.', 'What am I?'], pausesMs:[400,0], answer: 'breath' },
    { id: 'gen-14', subject: 'general', lines: ['What has keys but cannot open locks?'], pausesMs:[0], answer: 'piano' },
    { id: 'gen-15', subject: 'general', lines: ['What can you hold in your right hand but never your left?'], pausesMs:[0], answer: 'your left hand' },
    { id: 'gen-16', subject: 'general', lines: ['What has a head and a tail but no body?'], pausesMs:[0], answer: 'coin' },
    { id: 'gen-17', subject: 'general', lines: ['What question can you never answer yes to?'], pausesMs:[0], answer: 'are you asleep' },
    { id: 'gen-18', subject: 'general', lines: ['What has a ring but no finger?'], pausesMs:[0], answer: 'telephone' },
    { id: 'gen-19', subject: 'general', lines: ['What is always coming but never arrives?'], pausesMs:[0], answer: 'tomorrow' },
    { id: 'gen-20', subject: 'general', lines: ['What can fill a room but takes up no space?'], pausesMs:[0], answer: 'light' },
    { id: 'gen-21', subject: 'general', lines: ['What is full of holes but still holds water?'], pausesMs:[0], answer: 'sponge' },
    { id: 'gen-22', subject: 'general', lines: ['What can you catch but never throw?'], pausesMs:[0], answer: 'cold' },
    { id: 'gen-23', subject: 'general', lines: ['What kind of band never plays music?'], pausesMs:[0], answer: 'rubber band' },
    { id: 'gen-24', subject: 'general', lines: ['What building has the most stories?'], pausesMs:[0], answer: 'library' },
    { id: 'gen-25', subject: 'general', lines: ['What has many words but never speaks?'], pausesMs:[0], answer: 'book' },
    { id: 'gen-26', subject: 'general', lines: ['If you have me you want to share me,', 'If you share me you do not have me.','What am I?'], pausesMs:[400,400,0], answer: 'secret' },
    { id: 'gen-27', subject: 'general', lines: ['I go up when rain comes down.', 'What am I?'], pausesMs:[400,0], answer: 'umbrella' },
    { id: 'gen-28', subject: 'general', lines: ['What room has no doors or windows?'], pausesMs:[0], answer: 'mushroom' },
    { id: 'gen-29', subject: 'general', lines: ['Which month has 28 days?'], pausesMs:[0], answer: 'all of them' },
    { id: 'gen-30', subject: 'general', lines: ['I have cities but no houses,', 'Mountains but no trees,', 'Water but no fish.', 'What am I?'], pausesMs:[400,400,400,0], answer: 'map' },
  ],
  math: [
