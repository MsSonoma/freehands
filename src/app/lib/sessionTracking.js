 ...
 */
export async function startLessonSession(learnerId, lessonId, browserSessionId = null, deviceName = null, takeoverAuthorized = false, expectedConflictingSessionId = null, occurrenceId = null, instructionalTeacher = null) {
  ...
  try {
    ...
    const response = await fetch('/api/syllabus/execution/start', {
      ...
      body: JSON.stringify({
        ...
        ...(takeoverAuthorized ? { takeoverAuthorized: true, expectedConflictingSessionId } : {}),
      }),
    });
