...
function getReportableFeatures() {
  return [
    ...
    },
    {
      ...
      description:
        "Curriculum preferences are represented in the learner's active Syllabus teaching guidance. They are learner-specific planning guardrails, such as focus areas or topics to avoid, and they stay under facilitator control.",
      howToUse:
        "Ask me to review the selected learner's Syllabus teaching guidance. If you want it changed, tell me the new guidance and I can prepare the active-Syllabus change for your confirmation.",
      relatedFeatures: [],
      report: {
    ...
    },
    {
      ...
      description:
        'Weekly pattern is part of the learner?s active Syllabus. It expresses the facilitator-authored rhythm of subjects across the week and guides future instructional planning.',
      howToUse:
        "Ask me to inspect the selected learner's active Syllabus. If you want the weekly pattern changed, tell me the new pattern and I can prepare the active-Syllabus change for your confirmation.",
      relatedFeatures: [],
      report: {
    ...
    },
    {
      ...
      description:
        'Planned lessons are the dated instructional intent and forecast represented by the learner?s Syllabus. The active Syllabus is authoritative; learning-forecast proposals remain proposals until accepted or materialized.',
      howToUse:
        "Ask me to review the selected learner's Syllabus, upcoming instructional plan, or learning forecast. I can inspect current evidence before proposing what should come next.",
