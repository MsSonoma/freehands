...
const lessonsDir = path.resolve('public', 'lessons', 'social studies');
...
async function validateFile(filePath) {
  ...
  // wordProblems must not exist for social studies
...
async function main() {
  ...
  if (files.length === 0) {
    console.log('No 3rd grade social studies lesson files found.');
    process.exit(1);
  }
