...
Prompt (original):
```text
Regression: CalendarOverlay loses 2025 schedule again (blank schedule). Find where CalendarOverlay clears scheduledLessons/plannedLessons and how to preserve last-known data across reloads.
```
